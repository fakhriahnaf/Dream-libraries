...
<head>
    ...
    <title>Wellcome to dream Perpustakaan</title>
                ...
                <div class="container">
                    <div class="navbar-header">
                        <a class="navbar-brand" href="#">
                            <img src="https://png-5.vector.me/files/images/3/5/350819/book_thumb" height=" 200">
                            <strong style="margin-left:10px;">
                                  <h1>  <b>Dream  </b>Libraries </h1>
                            </strong>
                        </a>
                    </div>
                    <!-- start:navbar-header -->
                    ...
                    <div class="collapse navbar-collapse navbar-ex1-collapse">
                        <ul class="nav navbar-nav navbar-right top-menu" role="navigation">
                                <li class="">
                                    <a href="https://www.instagram.com/fakhri_ahnaf/">
                                ...
                                <li class="">
                                    <a href="https://www.facebook.com/fakhri.ahnafdhia">
                                        <div class="text-center">
...
<div class="login-box">
    <div class="login-logo">
        <a href="{{ url('/home') }}"><b>Dream  </b>Perpustakaan</a>
    </div>
